 ...
 * on 2016-01-22 at 19:22:24 UTC 
 * Modify at your own risk.
 */

package com.example.ark.myapplication.backend.myApi;
...
public class MyApi extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  /**
   * Create a request for the method "jokesLib".
   *
   * This request holds the parameters needed by the myApi server.  After setting any optional
   * parameters, call the {@link JokesLib#execute()} method to invoke the remote operation.
   *
   * @return the request
   */
  public JokesLib jokesLib() throws java.io.IOException {
    JokesLib result = new JokesLib();
    initialize(result);
    return result;
  }

  public class JokesLib extends MyApiRequest<com.example.ark.myapplication.backend.myApi.model.MyJokes> {

    private static final String REST_PATH = "jokesLib";

    /**
     * Create a request for the method "jokesLib".
     *
     * This request holds the parameters needed by the the myApi server.  After setting any optional
     * parameters, call the {@link JokesLib#execute()} method to invoke the remote operation. <p>
     * {@link
     * JokesLib#initialize(com.google.api.client.googleapis.services.AbstractGoogleClientRequest)}
     * must be called to initialize this instance immediately after invoking the constructor. </p>
     *
     * @since 1.13
     */
    protected JokesLib() {
      super(MyApi.this, "POST", REST_PATH, null, com.example.ark.myapplication.backend.myApi.model.MyJokes.class);
    }

    @Override
    public JokesLib setAlt(java.lang.String alt) {
      return (JokesLib) super.setAlt(alt);
    }

    @Override
    public JokesLib setFields(java.lang.String fields) {
      return (JokesLib) super.setFields(fields);
    }

    @Override
    public JokesLib setKey(java.lang.String key) {
      return (JokesLib) super.setKey(key);
    }

    @Override
    public JokesLib setOauthToken(java.lang.String oauthToken) {
      return (JokesLib) super.setOauthToken(oauthToken);
    }

    @Override
    public JokesLib setPrettyPrint(java.lang.Boolean prettyPrint) {
      return (JokesLib) super.setPrettyPrint(prettyPrint);
    }

    @Override
    public JokesLib setQuotaUser(java.lang.String quotaUser) {
      return (JokesLib) super.setQuotaUser(quotaUser);
    }

    @Override
    public JokesLib setUserIp(java.lang.String userIp) {
      return (JokesLib) super.setUserIp(userIp);
    }

    @Override
    public JokesLib set(String parameterName, Object value) {
      return (JokesLib) super.set(parameterName, value);
    }
  }
  ...
  public class SayHi extends MyApiRequest<com.example.ark.myapplication.backend.myApi.model.MyBean> {
    ...
    protected SayHi(java.lang.String name) {
      super(MyApi.this, "POST", REST_PATH, null, com.example.ark.myapplication.backend.myApi.model.MyBean.class);
